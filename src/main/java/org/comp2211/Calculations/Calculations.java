...
public class Calculations {
    ...
    public Runway recalculateToraTowards(Runway runway, Obstruction obstruction){
        int tora  =  obstruction.getDistanceFromCl() + runway.getdThreshold() - (obstruction.getHeight() * obstruction.getDistanceFromCl()) -runway.getStripEnd();
        runway.setTora(tora);
        return runway;
    }

    public Runway recalculateToraAwayOver(Runway runway, Obstruction obstruction){
        int tora  =  runway.getTora() - obstruction.getDistanceFromCl() - runway.getdThreshold() - runway.getResa() - runway.getStripEnd();
        runway.setTora(tora);
        return runway;
    }
    ...
    public Runway recalculateLdaAwayOver(Runway runway, Obstruction obstruction){
        int lda = runway.getLda() - obstruction.getDistanceFromCl() - runway.getStripEnd() - (obstruction.getHeight() * obstruction.getDistanceFromCl());
        runway.setLda(lda);
        return runway;
    }
